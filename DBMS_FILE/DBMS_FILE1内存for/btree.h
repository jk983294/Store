...
public:
	...
	void split_node(record re,node block,int left,int right);     //分离结点

	//void split_node(record re,int block,int left,int right);     //分离结点
