/**
 * Namespace injection is another variation on the IIFE
 * where we "inject" the methods and properties for a specific namespace
 * from within a function wrapper using this as a namespace proxy.
 */
var myApp = myApp || {};
myApp.utils =  {};
...
}).apply( myApp.utils );    //this should be myApp.utils
