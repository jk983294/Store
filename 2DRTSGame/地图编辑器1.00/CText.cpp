                    ...
                    DWORD LastTime)
{
    ...
    GetText(lpSurf,x,y,szBuffer,color,LastTime);
}
/****************************************
*  函数名:  GetText(...)
*    功能:  获得要显示的浮点数并设置对
...
void CText::TextBackSurf(LONG x,LONG y,
                                    ...
                                    DWORD LastTime)
{
    GetText(lpDDSBack,x,y,lpText,color,LastTime);
}
/****************************************
*  函数名:  TextBackSurf(...)
*    功能:  指定要在后台缓冲表面中显示的整数
...
void CText::TextBackSurf(LONG x,LONG y,
                         ...
                         DWORD LastTime)
{
    GetText(lpDDSBack,x,y,lNumber,color,LastTime);
}
/****************************************
*  函数名:  TextBackSurf(...)
...
void CText::TextBackSurf(LONG x,LONG y,
                         ...
                         DWORD LastTime)
{
    GetText(lpDDSBack,x,y,fNumber,color,LastTime);
}
